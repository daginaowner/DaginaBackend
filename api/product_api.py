...
@user_route.route("api/products/<string:category>", methods=['GET'])
...
@user_route.route("api/products/<string:pricerange>", methods=['GET'])
...
@user_route.route("api/products/<string:sellerId>", methods=['GET'])
...
@user_route.route("api/products/<string:productId>", methods=['GET'])
